...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-05-26 04:14 CST*

![](https://img.shields.io/badge/Total_Calls-5684-black)
![](https://img.shields.io/badge/Last_7_Days-385-blue)
...
| Judge Replaced | 5 | 3 | 0 | Corrected by powerful model. |
| Fallback (Error) | 50 | 22 | 0 | Automatic fallback to Gemini. |
| NAS Reflection | 25 | 13 | 0 | App used draft_provider='codex'; draft+judge ran entirely on NAS via gemini-cli. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 3817 | 250 | 32 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 3460 | 240 | 32 |
| CompanyInfo | 273 | 8 | 0 |
...
| Model | Total Calls | Last 7D | Last 24H | Avg Duration |
|-------|-------------|---------|----------|--------------|
| `whisper-large-v3` | 874 | 100 | 0 | N/A |
...
| whisper-transcription | 280 | 100 | 0 |
