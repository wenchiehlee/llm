...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-07-07 06:47 CST*
...
| Judge Replaced | 36 | 8 | 0 | Corrected by powerful model. |
| Fallback (Error) | 212 | 22 | 0 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 5447 | 249 | 32 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 5018 | 239 | 32 |
| CompanyInfo | 343 | 9 | 0 |
