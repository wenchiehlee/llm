...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-07-28 23:04 CST*

![](https://img.shields.io/badge/Total_Calls-9012-black)
![](https://img.shields.io/badge/Last_7_Days-361-blue)
...
| Fallback (Error) | 313 | 46 | 5 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 6291 | 295 | 36 | N/A |
