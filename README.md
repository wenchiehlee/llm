...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-05-31 03:52 CST*
...
| Judge Replaced | 7 | 2 | 0 | Corrected by powerful model. |
| Fallback (Error) | 68 | 21 | 0 | Automatic fallback to Gemini. |
| NAS Reflection | 34 | 11 | 0 | App used draft_provider='codex'; draft+judge ran entirely on NAS via gemini-cli. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 4040 | 257 | 36 | N/A |
