...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-08-20 23:15 CST*

![](https://img.shields.io/badge/Total_Calls-10480-black)
![](https://img.shields.io/badge/Last_7_Days-596-blue)
![](https://img.shields.io/badge/Last_24_Hours-94-green)
...
| Judge Replaced | 68 | 9 | 2 | Corrected by powerful model. |
| Fallback (Error) | 445 | 27 | 4 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 7383 | 453 | 72 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 6833 | 440 | 70 |
| CompanyInfo | 450 | 13 | 2 |
...
| Model | Total Calls | Last 7D | Last 24H | Avg Duration |
|-------|-------------|---------|----------|--------------|
| `whisper-large-v3` | 1357 | 53 | 6 | N/A |
...
| Application | Total Calls | Last 7D | Last 24H |
|-------------|-------------|---------|----------|
| whisper-transcription | 764 | 54 | 6 |
