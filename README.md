...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-09-10 08:35 CST*

![](https://img.shields.io/badge/Total_Calls-17196-black)
![](https://img.shields.io/badge/Last_7_Days-3853-blue)
...
| Fallback (Error) | 527 | 15 | 0 | Automatic fallback to Gemini. |
| NAS Reflection | 71 | 3 | 0 | App used draft_provider='codex'; draft+judge ran entirely on NAS via gemini-cli. |

#### Smart Routing by Application

| App | Total | Last 7D | Last 24H |
|-----|-------|---------|----------|
| CompanyInfo | 646 | 23 | 0 |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 8656 | 412 | 74 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 8047 | 393 | 74 |
| CompanyInfo | 502 | 15 | 0 |
| ConceptStocks | 32 | 0 | 0 |
| InvestorEvents | 29 | 0 | 0 |
| TAIEX_Finguider_Pro | 25 | 0 | 0 |
| skill-youtube-channel-srt-keyframe-extract | 12 | 1 | 0 |
| llm-api | 8 | 0 | 0 |
...
![](https://img.shields.io/badge/GoogleAlertManager-8047_calls-blue)
![](https://img.shields.io/badge/CompanyInfo-502_calls-green)
...
![](https://img.shields.io/badge/skill--youtube--channel--srt--keyframe--extract-12_calls-yellowgreen)
...
![](https://img.shields.io/badge/CompanyInfo-834_calls-blue)
...
| Model | Total Calls | Last 7D | Last 24H | Avg Duration |
|-------|-------------|---------|----------|--------------|
| `baidu/Unlimited-OCR` | 5167 | 3377 | 0 | N/A |
| `whisper-large-v3` | 1481 | 32 | 0 | N/A |
...
| Application | Total Calls | Last 7D | Last 24H |
|-------------|-------------|---------|----------|
| Baidu-OCR | 5167 | 3377 | 0 |
| whisper-transcription | 889 | 32 | 0 |
...
![](https://img.shields.io/badge/Baidu--OCR-5167_calls-blue)
![](https://img.shields.io/badge/whisper--transcription-889_calls-green)
