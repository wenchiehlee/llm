...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-09-09 18:07 CST*

![](https://img.shields.io/badge/Total_Calls-16638-black)
![](https://img.shields.io/badge/Last_7_Days-4035-blue)
![](https://img.shields.io/badge/Last_24_Hours-614-green)
...
![](./assets/chart_total_by_app.svg)

![](./assets/chart_total_by_model.svg)
...
| Judge Replaced | 83 | 5 | 0 | Corrected by powerful model. |
| Fallback (Error) | 523 | 14 | 0 | Automatic fallback to Gemini. |
| NAS Reflection | 71 | 4 | 0 | App used draft_provider='codex'; draft+judge ran entirely on NAS via gemini-cli. |

#### Smart Routing by Application

| App | Total | Last 7D | Last 24H |
|-----|-------|---------|----------|
| CompanyInfo | 642 | 23 | 0 |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 8501 | 404 | 151 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 7897 | 386 | 150 |
| CompanyInfo | 498 | 14 | 0 |
| ConceptStocks | 32 | 0 | 0 |
| InvestorEvents | 29 | 0 | 0 |
| TAIEX_Finguider_Pro | 25 | 0 | 0 |
| skill-youtube-channel-srt-keyframe-extract | 11 | 1 | 1 |
| llm-api | 8 | 0 | 0 |
| TAIEX_Revenue_History | 5 | 0 | 0 |
| TravelAPP | 3 | 0 | 0 |
| TestSmartRouting | 2 | 0 | 0 |
| TW-institutional-investment-theses | 1 | 1 | 0 |
| TW-institutional-research | 1 | 1 | 0 |
| debug-probe-app | 1 | 0 | 0 |
| diagnostic-test | 1 | 1 | 0 |

![](https://img.shields.io/badge/GoogleAlertManager-7897_calls-blue)
![](https://img.shields.io/badge/CompanyInfo-498_calls-green)
...
![](https://img.shields.io/badge/skill--youtube--channel--srt--keyframe--extract-11_calls-yellowgreen)
![](https://img.shields.io/badge/llm--api-8_calls-cyan)
![](https://img.shields.io/badge/TAIEX_Revenue_History-5_calls-teal)
![](https://img.shields.io/badge/TravelAPP-3_calls-pink)
![](https://img.shields.io/badge/TestSmartRouting-2_calls-indigo)
![](https://img.shields.io/badge/TW--institutional--investment--theses-1_calls-blue)
![](https://img.shields.io/badge/TW--institutional--research-1_calls-green)
![](https://img.shields.io/badge/debug--probe--app-1_calls-orange)
![](https://img.shields.io/badge/diagnostic--test-1_calls-red)
...
![](https://img.shields.io/badge/CompanyInfo-830_calls-blue)
...
![](https://img.shields.io/badge/skill--youtube--channel--srt--keyframe--extract-39_calls-purple)
![](https://img.shields.io/badge/TAIEX_Revenue_History-33_calls-yellowgreen)
![](https://img.shields.io/badge/ConceptStocks-27_calls-cyan)
![](https://img.shields.io/badge/InvestorEvents-23_calls-teal)
![](https://img.shields.io/badge/llm--api-22_calls-pink)
![](https://img.shields.io/badge/ServerSmartTest-14_calls-indigo)
![](https://img.shields.io/badge/TAIEX_Compare-10_calls-blue)
![](https://img.shields.io/badge/TAIEX_Finguider_Gen-7_calls-green)
![](https://img.shields.io/badge/TAIEX_Visualizer-7_calls-orange)
![](https://img.shields.io/badge/SmartTest-6_calls-red)
...
| Model | Total Calls | Last 7D | Last 24H | Avg Duration |
|-------|-------------|---------|----------|--------------|
| `baidu/Unlimited-OCR` | 4770 | 3568 | 461 | N/A |
| `whisper-large-v3` | 1479 | 32 | 2 | N/A |
...
| Application | Total Calls | Last 7D | Last 24H |
|-------------|-------------|---------|----------|
| Baidu-OCR | 4770 | 3568 | 461 |
| whisper-transcription | 887 | 32 | 2 |
...
![](https://img.shields.io/badge/Baidu--OCR-4770_calls-blue)
![](https://img.shields.io/badge/whisper--transcription-887_calls-green)
