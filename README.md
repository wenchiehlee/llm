...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-09-18 14:39 CST*

![](https://img.shields.io/badge/Total_Calls-19373-black)
![](https://img.shields.io/badge/Last_7_Days-1554-blue)
![](https://img.shields.io/badge/Last_24_Hours-654-green)
...
| Fallback (Error) | 559 | 24 | 0 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 9438 | 706 | 136 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 8797 | 682 | 136 |
| CompanyInfo | 534 | 24 | 0 |
...
![](https://img.shields.io/badge/GoogleAlertManager-8797_calls-blue)
![](https://img.shields.io/badge/CompanyInfo-534_calls-green)
...
![](https://img.shields.io/badge/CompanyInfo-866_calls-blue)
...
| Model | Total Calls | Last 7D | Last 24H | Avg Duration |
|-------|-------------|---------|----------|--------------|
| `baidu/Unlimited-OCR` | 6497 | 803 | 518 | N/A |
| `whisper-large-v3` | 1514 | 21 | 0 | N/A |
...
| Application | Total Calls | Last 7D | Last 24H |
|-------------|-------------|---------|----------|
| Baidu-OCR | 6499 | 803 | 518 |
| whisper-transcription | 922 | 21 | 0 |
...
![](https://img.shields.io/badge/Baidu--OCR-6499_calls-blue)
![](https://img.shields.io/badge/whisper--transcription-922_calls-green)
