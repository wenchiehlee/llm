...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-06-09 21:33 CST*

![](https://img.shields.io/badge/Total_Calls-6367-black)
![](https://img.shields.io/badge/Last_7_Days-374-blue)
...
| Judge Replaced | 13 | 3 | 1 | Corrected by powerful model. |
| Fallback (Error) | 102 | 26 | 2 | Automatic fallback to Gemini. |
| NAS Reflection | 51 | 10 | 2 | App used draft_provider='codex'; draft+judge ran entirely on NAS via gemini-cli. |

#### Smart Routing by Application

| App | Total | Last 7D | Last 24H |
|-----|-------|---------|----------|
| CompanyInfo | 136 | 40 | 5 |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 4378 | 297 | 36 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 3996 | 285 | 35 |
| CompanyInfo | 297 | 12 | 1 |
