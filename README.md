...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-06-22 22:17 CST*

![](https://img.shields.io/badge/Total_Calls-6960-black)
![](https://img.shields.io/badge/Last_7_Days-309-blue)
...
| Fallback (Error) | 154 | 33 | 6 | Automatic fallback to Gemini. |
| NAS Reflection | 60 | 3 | 0 | App used draft_provider='codex'; draft+judge ran entirely on NAS via gemini-cli. |

#### Smart Routing by Application

| App | Total | Last 7D | Last 24H |
|-----|-------|---------|----------|
| CompanyInfo | 206 | 38 | 6 |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 4864 | 265 | 37 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 4459 | 251 | 35 |
| CompanyInfo | 320 | 14 | 2 |
