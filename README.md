...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-06-09 09:31 CST*

![](https://img.shields.io/badge/Total_Calls-6367-black)
![](https://img.shields.io/badge/Last_7_Days-367-blue)
...
| Judge Replaced | 13 | 2 | 0 | Corrected by powerful model. |
| Fallback (Error) | 102 | 24 | 0 | Automatic fallback to Gemini. |
| NAS Reflection | 51 | 8 | 0 | App used draft_provider='codex'; draft+judge ran entirely on NAS via gemini-cli. |

#### Smart Routing by Application

| App | Total | Last 7D | Last 24H |
|-----|-------|---------|----------|
| CompanyInfo | 136 | 35 | 0 |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 4378 | 295 | 34 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 3996 | 284 | 34 |
| CompanyInfo | 297 | 11 | 0 |
