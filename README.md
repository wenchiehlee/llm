...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-09-05 01:48 CST*

![](https://img.shields.io/badge/Total_Calls-11670-black)
![](https://img.shields.io/badge/Last_7_Days-401-blue)
...
| Fallback (Error) | 514 | 12 | 0 | Automatic fallback to Gemini. |
| NAS Reflection | 69 | 9 | 0 | App used draft_provider='codex'; draft+judge ran entirely on NAS via gemini-cli. |

#### Smart Routing by Application

| App | Total | Last 7D | Last 24H |
|-----|-------|---------|----------|
| CompanyInfo | 626 | 23 | 0 |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 8352 | 322 | 0 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 7760 | 309 | 0 |
| CompanyInfo | 489 | 12 | 0 |
...
![](https://img.shields.io/badge/GoogleAlertManager-7760_calls-blue)
![](https://img.shields.io/badge/CompanyInfo-489_calls-green)
...
![](https://img.shields.io/badge/CompanyInfo-806_calls-blue)
...
| Model | Total Calls | Last 7D | Last 24H | Avg Duration |
|-------|-------------|---------|----------|--------------|
| `whisper-large-v3` | 1454 | 58 | 3 | N/A |
...
| Application | Total Calls | Last 7D | Last 24H |
|-------------|-------------|---------|----------|
| whisper-transcription | 862 | 59 | 3 |
