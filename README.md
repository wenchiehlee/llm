...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-09-11 14:38 CST*

![](https://img.shields.io/badge/Total_Calls-18178-black)
![](https://img.shields.io/badge/Last_7_Days-4064-blue)
...
| Fallback (Error) | 531 | 17 | 0 | Automatic fallback to Gemini. |
| NAS Reflection | 71 | 2 | 0 | App used draft_provider='codex'; draft+judge ran entirely on NAS via gemini-cli. |

#### Smart Routing by Application

| App | Total | Last 7D | Last 24H |
|-----|-------|---------|----------|
| CompanyInfo | 650 | 24 | 0 |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 8796 | 512 | 68 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 8183 | 491 | 68 |
| CompanyInfo | 506 | 17 | 0 |
...
![](https://img.shields.io/badge/GoogleAlertManager-8183_calls-blue)
![](https://img.shields.io/badge/CompanyInfo-506_calls-green)
...
![](https://img.shields.io/badge/CompanyInfo-838_calls-blue)
...
| Model | Total Calls | Last 7D | Last 24H | Avg Duration |
|-------|-------------|---------|----------|--------------|
| `baidu/Unlimited-OCR` | 5996 | 3478 | 0 | N/A |
| `whisper-large-v3` | 1490 | 42 | 3 | N/A |
...
| whisper-transcription | 898 | 42 | 3 |
...
![](https://img.shields.io/badge/whisper--transcription-898_calls-green)
