...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-07-31 02:59 CST*
...
| Judge Replaced | 56 | 2 | 0 | Corrected by powerful model. |
| Fallback (Error) | 332 | 39 | 0 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 6403 | 255 | 34 | N/A |
