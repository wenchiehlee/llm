...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-07-16 09:08 CST*
...
| Judge Replaced | 48 | 9 | 0 | Corrected by powerful model. |
| Fallback (Error) | 239 | 16 | 0 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 5806 | 282 | 34 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 5362 | 274 | 34 |
| CompanyInfo | 355 | 8 | 0 |
...
| whisper-transcription | 390 | 17 | 6 |
