...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-08-21 18:05 CST*

![](https://img.shields.io/badge/Total_Calls-10574-black)
![](https://img.shields.io/badge/Last_7_Days-610-blue)
...
| Judge Replaced | 70 | 9 | 1 | Corrected by powerful model. |
| Fallback (Error) | 449 | 30 | 6 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 7455 | 491 | 76 | N/A |
...
| Model | Total Calls | Last 7D | Last 24H | Avg Duration |
|-------|-------------|---------|----------|--------------|
| `whisper-large-v3` | 1363 | 42 | 3 | N/A |
...
| Application | Total Calls | Last 7D | Last 24H |
|-------------|-------------|---------|----------|
| whisper-transcription | 770 | 42 | 3 |
