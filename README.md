...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-08-12 18:42 CST*

![](https://img.shields.io/badge/Total_Calls-9842-black)
![](https://img.shields.io/badge/Last_7_Days-425-blue)
...
| Judge Replaced | 60 | 4 | 1 | Corrected by powerful model. |
| Fallback (Error) | 410 | 35 | 5 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 6917 | 307 | 37 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 6392 | 290 | 35 |
| CompanyInfo | 434 | 17 | 2 |
...
| Model | Total Calls | Last 7D | Last 24H | Avg Duration |
|-------|-------------|---------|----------|--------------|
| `whisper-large-v3` | 1284 | 78 | 18 | N/A |
...
| Application | Total Calls | Last 7D | Last 24H |
|-------------|-------------|---------|----------|
| whisper-transcription | 690 | 78 | 18 |
