...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-07-17 15:36 CST*

![](https://img.shields.io/badge/Total_Calls-8271-black)
![](https://img.shields.io/badge/Last_7_Days-432-blue)
...
| Judge Replaced | 49 | 8 | 0 | Corrected by powerful model. |
| Fallback (Error) | 244 | 17 | 0 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 5844 | 284 | 36 | N/A |
...
| Model | Total Calls | Last 7D | Last 24H | Avg Duration |
|-------|-------------|---------|----------|--------------|
| `whisper-large-v3` | 1014 | 100 | 55 | N/A |
...
| whisper-transcription | 420 | 100 | 55 |
