...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-07-06 05:39 CST*

![](https://img.shields.io/badge/Total_Calls-7638-black)
![](https://img.shields.io/badge/Last_7_Days-308-blue)
...
| Judge Replaced | 34 | 6 | 0 | Corrected by powerful model. |
| Fallback (Error) | 208 | 24 | 0 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 5412 | 250 | 32 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 4985 | 240 | 32 |
| CompanyInfo | 341 | 9 | 0 |
...
| whisper-transcription | 320 | 10 | 0 |
