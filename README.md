...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-08-04 23:09 CST*

![](https://img.shields.io/badge/Total_Calls-9361-black)
![](https://img.shields.io/badge/Last_7_Days-352-blue)
...
| Fallback (Error) | 360 | 50 | 8 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 6564 | 276 | 39 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 6064 | 252 | 35 |
| CompanyInfo | 411 | 24 | 4 |
