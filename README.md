...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-05-18 13:57 CST*
...
| Fallback (Error) | 20 | 20 | 0 | Automatic fallback to Gemini. |
| NAS Reflection | 8 | 8 | 0 | App used draft_provider='codex'; draft+judge ran entirely on NAS via gemini-cli. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 3454 | 358 | 59 | N/A |
