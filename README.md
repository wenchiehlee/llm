...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-08-23 19:56 CST*

![](https://img.shields.io/badge/Total_Calls-10794-black)
![](https://img.shields.io/badge/Last_7_Days-587-blue)
...
| Judge Replaced | 71 | 7 | 1 | Corrected by powerful model. |
| Fallback (Error) | 462 | 36 | 5 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 7643 | 487 | 75 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 7085 | 470 | 73 |
| CompanyInfo | 458 | 17 | 2 |
...
| Model | Total Calls | Last 7D | Last 24H | Avg Duration |
|-------|-------------|---------|----------|--------------|
| `whisper-large-v3` | 1378 | 30 | 3 | N/A |
...
| Application | Total Calls | Last 7D | Last 24H |
|-------------|-------------|---------|----------|
| whisper-transcription | 785 | 30 | 3 |
