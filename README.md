...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-07-19 20:37 CST*
...
| Judge Replaced | 52 | 7 | 0 | Corrected by powerful model. |
| Fallback (Error) | 254 | 27 | 6 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 5921 | 257 | 38 | N/A |
...
| Model | Total Calls | Last 7D | Last 24H | Avg Duration |
|-------|-------------|---------|----------|--------------|
| `whisper-large-v3` | 1180 | 237 | 26 | N/A |
...
| Application | Total Calls | Last 7D | Last 24H |
|-------------|-------------|---------|----------|
| whisper-transcription | 589 | 237 | 26 |
