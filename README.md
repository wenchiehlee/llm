...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-06-20 16:35 CST*

![](https://img.shields.io/badge/Total_Calls-6900-black)
...
| Judge Replaced | 22 | 4 | 0 | Corrected by powerful model. |
| Fallback (Error) | 139 | 18 | 0 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 4820 | 256 | 35 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 4422 | 248 | 35 |
| CompanyInfo | 313 | 8 | 0 |
