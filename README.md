...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-07-30 20:15 CST*

![](https://img.shields.io/badge/Total_Calls-9103-black)
![](https://img.shields.io/badge/Last_7_Days-317-blue)
...
| Judge Replaced | 55 | 2 | 1 | Corrected by powerful model. |
| Fallback (Error) | 326 | 47 | 6 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 6366 | 259 | 37 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 5882 | 236 | 34 |
| CompanyInfo | 395 | 23 | 3 |
