...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-08-17 17:23 CST*
...
| Judge Replaced | 65 | 6 | 1 | Corrected by powerful model. |
| Fallback (Error) | 431 | 29 | 2 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 7235 | 394 | 76 | N/A |
