...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-05-29 09:34 CST*
...
| Fallback (Error) | 59 | 20 | 0 | Automatic fallback to Gemini. |
| NAS Reflection | 28 | 12 | 0 | App used draft_provider='codex'; draft+judge ran entirely on NAS via gemini-cli. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 3928 | 255 | 35 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 3567 | 246 | 35 |
| CompanyInfo | 277 | 7 | 0 |
