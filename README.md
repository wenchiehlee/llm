...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-08-28 14:21 CST*

![](https://img.shields.io/badge/Total_Calls-11169-black)
![](https://img.shields.io/badge/Last_7_Days-543-blue)
...
| Judge Replaced | 75 | 4 | 1 | Corrected by powerful model. |
| Fallback (Error) | 492 | 37 | 6 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 7953 | 458 | 39 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 7379 | 439 | 36 |
| CompanyInfo | 472 | 17 | 3 |
...
| Model | Total Calls | Last 7D | Last 24H | Avg Duration |
|-------|-------------|---------|----------|--------------|
| `whisper-large-v3` | 1390 | 24 | 0 | N/A |
...
| Application | Total Calls | Last 7D | Last 24H |
|-------------|-------------|---------|----------|
| whisper-transcription | 797 | 24 | 0 |
