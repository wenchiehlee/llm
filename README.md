...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-07-11 06:40 CST*

![](https://img.shields.io/badge/Total_Calls-7930-black)
...
| Judge Replaced | 41 | 9 | 0 | Corrected by powerful model. |
| Fallback (Error) | 227 | 21 | 0 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 5596 | 252 | 35 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 5158 | 240 | 35 |
| CompanyInfo | 349 | 9 | 0 |
