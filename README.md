...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-07-20 10:51 CST*
...
| Judge Replaced | 52 | 5 | 0 | Corrected by powerful model. |
| Fallback (Error) | 260 | 23 | 0 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 5959 | 256 | 32 | N/A |
