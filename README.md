...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-09-19 21:29 CST*

![](https://img.shields.io/badge/Total_Calls-19822-black)
![](https://img.shields.io/badge/Last_7_Days-1570-blue)
![](https://img.shields.io/badge/Last_24_Hours-79-green)
...
| Fallback (Error) | 563 | 28 | 4 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 9578 | 712 | 72 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 8933 | 684 | 68 |
| CompanyInfo | 538 | 28 | 4 |
...
![](https://img.shields.io/badge/GoogleAlertManager-8933_calls-blue)
![](https://img.shields.io/badge/CompanyInfo-538_calls-green)
...
![](https://img.shields.io/badge/CompanyInfo-870_calls-blue)
...
| `whisper-large-v3` | 1517 | 27 | 3 | N/A |
...
| whisper-transcription | 925 | 27 | 3 |
...
![](https://img.shields.io/badge/whisper--transcription-925_calls-green)
