...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-08-06 19:06 CST*

![](https://img.shields.io/badge/Total_Calls-9469-black)
![](https://img.shields.io/badge/Last_7_Days-382-blue)
...
| Judge Replaced | 57 | 1 | 0 | Corrected by powerful model. |
| Fallback (Error) | 380 | 56 | 8 | Automatic fallback to Gemini. |
...
|-----|-------|---------|----------|
| CompanyInfo | 462 | 53 | 8 |
| InvestorEvents | 29 | 0 | 0 |
| ConceptStocks | 16 | 7 | 0 |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 6647 | 283 | 39 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 6137 | 256 | 35 |
| CompanyInfo | 419 | 25 | 4 |
...
| Model | Total Calls | Last 7D | Last 24H | Avg Duration |
|-------|-------------|---------|----------|--------------|
| `whisper-large-v3` | 1224 | 25 | 15 | N/A |
...
| Application | Total Calls | Last 7D | Last 24H |
|-------------|-------------|---------|----------|
| whisper-transcription | 630 | 25 | 15 |
