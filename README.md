...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-07-18 23:36 CST*

![](https://img.shields.io/badge/Total_Calls-8403-black)
![](https://img.shields.io/badge/Last_7_Days-555-blue)
![](https://img.shields.io/badge/Last_24_Hours-133-green)
...
| Judge Replaced | 51 | 9 | 1 | Corrected by powerful model. |
| Fallback (Error) | 248 | 25 | 6 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 5882 | 289 | 39 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 5434 | 277 | 36 |
| CompanyInfo | 359 | 12 | 3 |
...
| Model | Total Calls | Last 7D | Last 24H | Avg Duration |
|-------|-------------|---------|----------|--------------|
| `whisper-large-v3` | 1097 | 207 | 83 | N/A |
...
| whisper-transcription | 504 | 209 | 85 |
