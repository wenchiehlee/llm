...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-08-23 13:06 CST*
...
| Judge Replaced | 71 | 6 | 0 | Corrected by powerful model. |
| Fallback (Error) | 462 | 31 | 0 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 7643 | 485 | 73 | N/A |
