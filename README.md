...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-05-18 22:45 CST*

![](https://img.shields.io/badge/Total_Calls-5212-black)
...
| Fallback (Error) | 20 | 24 | 4 | Automatic fallback to Gemini. |
| NAS Reflection | 8 | 10 | 2 | App used draft_provider='codex'; draft+judge ran entirely on NAS via gemini-cli. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 3454 | 360 | 61 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 3145 | 319 | 59 |
| CompanyInfo | 261 | 19 | 2 |
| ConceptStocks | 30 | 9 | 0 |
| InvestorEvents | 26 | 4 | 0 |
| TAIEX_Finguider_Pro | 22 | 5 | 0 |
| llm-api | 8 | 0 | 0 |
