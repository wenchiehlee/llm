...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-08-16 21:58 CST*

![](https://img.shields.io/badge/Total_Calls-10206-black)
...
| Judge Replaced | 63 | 6 | 2 | Corrected by powerful model. |
| Fallback (Error) | 429 | 31 | 2 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 7158 | 392 | 78 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 6616 | 369 | 77 |
| CompanyInfo | 442 | 14 | 1 |
...
| llm-api | 22 | 0 | 0 |
| skill-youtube-channel-srt-keyframe-extract | 19 | 24 | 5 |
