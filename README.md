...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-08-06 06:41 CST*

![](https://img.shields.io/badge/Total_Calls-9469-black)
![](https://img.shields.io/badge/Last_7_Days-353-blue)
...
| Fallback (Error) | 380 | 48 | 0 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 6647 | 277 | 33 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 6137 | 254 | 33 |
| CompanyInfo | 419 | 21 | 0 |
...
| Model | Total Calls | Last 7D | Last 24H | Avg Duration |
|-------|-------------|---------|----------|--------------|
| `whisper-large-v3` | 1224 | 10 | 0 | N/A |
...
| Application | Total Calls | Last 7D | Last 24H |
|-------------|-------------|---------|----------|
| whisper-transcription | 630 | 10 | 0 |
