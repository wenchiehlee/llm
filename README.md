...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-08-02 23:43 CST*
...
| Fallback (Error) | 344 | 47 | 8 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 6478 | 263 | 40 | N/A |
