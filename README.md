...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-08-29 03:00 CST*
...
| Fallback (Error) | 492 | 30 | 0 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 7989 | 382 | 0 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 7415 | 366 | 0 |
| CompanyInfo | 472 | 14 | 0 |
