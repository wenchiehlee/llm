...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-08-29 22:41 CST*

![](https://img.shields.io/badge/Total_Calls-11211-black)
![](https://img.shields.io/badge/Last_7_Days-511-blue)
...
| Judge Replaced | 75 | 5 | 1 | Corrected by powerful model. |
| Fallback (Error) | 492 | 40 | 10 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 7989 | 423 | 41 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 7415 | 402 | 36 |
| CompanyInfo | 472 | 19 | 5 |
...
| Model | Total Calls | Last 7D | Last 24H | Avg Duration |
|-------|-------------|---------|----------|--------------|
| `whisper-large-v3` | 1396 | 18 | 0 | N/A |
...
| Application | Total Calls | Last 7D | Last 24H |
|-------------|-------------|---------|----------|
| whisper-transcription | 803 | 18 | 0 |
