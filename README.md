...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-07-22 07:40 CST*

![](https://img.shields.io/badge/Total_Calls-8695-black)
![](https://img.shields.io/badge/Last_7_Days-539-blue)
...
| Fallback (Error) | 272 | 33 | 0 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 6032 | 260 | 34 | N/A |
