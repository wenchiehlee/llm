...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-08-15 22:57 CST*

![](https://img.shields.io/badge/Total_Calls-10052-black)
![](https://img.shields.io/badge/Last_7_Days-552-blue)
![](https://img.shields.io/badge/Last_24_Hours-113-green)
...
| Judge Replaced | 62 | 5 | 1 | Corrected by powerful model. |
| Fallback (Error) | 425 | 35 | 4 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 7040 | 390 | 77 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 6500 | 365 | 75 |
| CompanyInfo | 440 | 16 | 2 |
...
| llm-api | 22 | 0 | 0 |
| skill-youtube-channel-srt-keyframe-extract | 19 | 19 | 0 |
...
| Model | Total Calls | Last 7D | Last 24H | Avg Duration |
|-------|-------------|---------|----------|--------------|
| `whisper-large-v3` | 1324 | 80 | 27 | N/A |
| `mlx-qwen3` | 44 | 0 | 0 | N/A |
| `mlx-gemma4` | 20 | 0 | 0 | N/A |
| `mlx-community/whisper-large-v3-turbo` | 12 | 1 | 0 | N/A |
...
| Application | Total Calls | Last 7D | Last 24H |
|-------------|-------------|---------|----------|
| whisper-transcription | 731 | 81 | 27 |
