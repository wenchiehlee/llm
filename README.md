...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-08-09 04:02 CST*

![](https://img.shields.io/badge/Total_Calls-9613-black)
![](https://img.shields.io/badge/Last_7_Days-356-blue)
...
| Judge Replaced | 58 | 1 | 0 | Corrected by powerful model. |
| Fallback (Error) | 394 | 42 | 0 | Automatic fallback to Gemini. |
...
|-----|-------|---------|----------|
| CompanyInfo | 477 | 39 | 0 |
| InvestorEvents | 29 | 0 | 0 |
| ConceptStocks | 16 | 4 | 0 |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 6727 | 247 | 38 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 6210 | 226 | 38 |
| CompanyInfo | 426 | 19 | 0 |
| ConceptStocks | 32 | 2 | 0 |
| InvestorEvents | 29 | 0 | 0 |
...
| Model | Total Calls | Last 7D | Last 24H | Avg Duration |
|-------|-------------|---------|----------|--------------|
| `whisper-large-v3` | 1271 | 60 | 8 | N/A |
...
| Application | Total Calls | Last 7D | Last 24H |
|-------------|-------------|---------|----------|
| whisper-transcription | 677 | 60 | 8 |
