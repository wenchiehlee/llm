...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-07-21 21:03 CST*

![](https://img.shields.io/badge/Total_Calls-8648-black)
![](https://img.shields.io/badge/Last_7_Days-562-blue)
...
| Fallback (Error) | 265 | 35 | 7 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 5993 | 263 | 39 | N/A |
