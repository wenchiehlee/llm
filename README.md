...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-06-10 20:46 CST*
...
| Judge Replaced | 14 | 4 | 1 | Corrected by powerful model. |
| Fallback (Error) | 104 | 25 | 5 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 4414 | 297 | 38 | N/A |
