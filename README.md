...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-09-26 08:09 CST*

![](https://img.shields.io/badge/Total_Calls-20610-black)
![](https://img.shields.io/badge/Last_7_Days-787-blue)
![](https://img.shields.io/badge/Last_24_Hours-81-green)
...
| Fallback (Error) | 591 | 24 | 0 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 10231 | 659 | 78 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 9558 | 635 | 78 |
| CompanyInfo | 566 | 24 | 0 |
...
![](https://img.shields.io/badge/GoogleAlertManager-9558_calls-blue)
![](https://img.shields.io/badge/CompanyInfo-566_calls-green)
...
![](https://img.shields.io/badge/CompanyInfo-898_calls-blue)
...
| `whisper-large-v3` | 1565 | 45 | 3 | N/A |
...
|-------------|-------------|---------|----------|
| Baidu-OCR | 6858 | 59 | 0 |
| whisper-transcription | 973 | 45 | 3 |
...
![](https://img.shields.io/badge/Baidu--OCR-6858_calls-blue)
![](https://img.shields.io/badge/whisper--transcription-973_calls-green)
