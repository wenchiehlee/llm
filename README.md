...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-06-15 22:47 CST*

![](https://img.shields.io/badge/Total_Calls-6656-black)
![](https://img.shields.io/badge/Last_7_Days-329-blue)
![](https://img.shields.io/badge/Last_24_Hours-40-green)
...
| Judge Replaced | 19 | 7 | 1 | Corrected by powerful model. |
| Fallback (Error) | 125 | 25 | 2 | Automatic fallback to Gemini. |
| NAS Reflection | 55 | 5 | 1 | App used draft_provider='codex'; draft+judge ran entirely on NAS via gemini-cli. |

#### Smart Routing by Application

| App | Total | Last 7D | Last 24H |
|-----|-------|---------|----------|
| CompanyInfo | 169 | 37 | 4 |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 4601 | 257 | 34 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 4209 | 247 | 34 |
| CompanyInfo | 307 | 11 | 1 |
