...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-08-26 15:31 CST*

![](https://img.shields.io/badge/Total_Calls-11019-black)
![](https://img.shields.io/badge/Last_7_Days-614-blue)
...
| Judge Replaced | 74 | 6 | 0 | Corrected by powerful model. |
| Fallback (Error) | 479 | 34 | 0 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 7834 | 526 | 75 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 7268 | 510 | 75 |
| CompanyInfo | 466 | 16 | 0 |
...
| Model | Total Calls | Last 7D | Last 24H | Avg Duration |
|-------|-------------|---------|----------|--------------|
| `whisper-large-v3` | 1384 | 27 | 0 | N/A |
...
| Application | Total Calls | Last 7D | Last 24H |
|-------------|-------------|---------|----------|
| whisper-transcription | 791 | 27 | 0 |
