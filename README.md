...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-05-19 12:46 CST*

![](https://img.shields.io/badge/Total_Calls-5243-black)
![](https://img.shields.io/badge/Last_7_Days-489-blue)
...
| Judge Replaced | 2 | 2 | 0 | Corrected by powerful model. |
| Fallback (Error) | 24 | 24 | 0 | Automatic fallback to Gemini. |
| NAS Reflection | 10 | 10 | 0 | App used draft_provider='codex'; draft+judge ran entirely on NAS via gemini-cli. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 3515 | 400 | 82 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 3170 | 368 | 82 |
| CompanyInfo | 263 | 15 | 0 |
| ConceptStocks | 30 | 6 | 0 |
| InvestorEvents | 26 | 4 | 0 |
| TAIEX_Finguider_Pro | 22 | 3 | 0 |
| llm-api | 8 | 0 | 0 |
| TAIEX_Revenue_History | 4 | 4 | 0 |
| TravelAPP | 3 | 0 | 0 |
...
| TAIEX_Finguider_Pro | 78 | 21 | 0 |
| TAIEX_Revenue_History | 31 | 31 | 0 |
| GoogleAlertManager | 27 | 0 | 0 |
| llm-api | 22 | 0 | 0 |
| ConceptStocks | 17 | 17 | 0 |
| InvestorEvents | 17 | 6 | 0 |
