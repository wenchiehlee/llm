...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-07-12 12:58 CST*

![](https://img.shields.io/badge/Total_Calls-7976-black)
![](https://img.shields.io/badge/Last_7_Days-406-blue)
![](https://img.shields.io/badge/Last_24_Hours-68-green)
...
| Judge Replaced | 43 | 9 | 0 | Corrected by powerful model. |
| Fallback (Error) | 229 | 21 | 0 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 5632 | 288 | 68 | N/A |
