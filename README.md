...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-07-30 05:35 CST*
...
| Judge Replaced | 55 | 1 | 0 | Corrected by powerful model. |
| Fallback (Error) | 326 | 41 | 0 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 6366 | 256 | 34 | N/A |
