...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-06-28 05:43 CST*
...
| Judge Replaced | 25 | 3 | 0 | Corrected by powerful model. |
| Fallback (Error) | 176 | 22 | 0 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 5122 | 291 | 33 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 4742 | 283 | 33 |
| CompanyInfo | 328 | 8 | 0 |
