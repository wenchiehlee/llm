...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-06-10 13:06 CST*

![](https://img.shields.io/badge/Total_Calls-6408-black)
...
| Judge Replaced | 14 | 3 | 0 | Corrected by powerful model. |
| Fallback (Error) | 104 | 20 | 0 | Automatic fallback to Gemini. |
| NAS Reflection | 53 | 10 | 0 | App used draft_provider='codex'; draft+judge ran entirely on NAS via gemini-cli. |

#### Smart Routing by Application

| App | Total | Last 7D | Last 24H |
|-----|-------|---------|----------|
| CompanyInfo | 141 | 34 | 0 |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 4414 | 295 | 36 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 4031 | 285 | 36 |
| CompanyInfo | 298 | 10 | 0 |
