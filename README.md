...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-08-27 05:13 CST*
...
| Judge Replaced | 74 | 4 | 0 | Corrected by powerful model. |
| Fallback (Error) | 486 | 37 | 0 | Automatic fallback to Gemini. |
...
| Model | Total Calls | Last 7D | Last 24H | Avg Duration |
|-------|-------------|---------|----------|--------------|
| `whisper-large-v3` | 1384 | 21 | 0 | N/A |
...
| Application | Total Calls | Last 7D | Last 24H |
|-------------|-------------|---------|----------|
| whisper-transcription | 791 | 21 | 0 |
