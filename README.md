...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-07-01 21:53 CST*

![](https://img.shields.io/badge/Total_Calls-7406-black)
...
| Fallback (Error) | 190 | 27 | 6 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 5230 | 255 | 38 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 4811 | 245 | 36 |
| CompanyInfo | 334 | 10 | 2 |
