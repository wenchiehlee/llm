...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-08-30 11:44 CST*

![](https://img.shields.io/badge/Total_Calls-11269-black)
![](https://img.shields.io/badge/Last_7_Days-461-blue)
![](https://img.shields.io/badge/Last_24_Hours-37-green)
...
| Judge Replaced | 76 | 4 | 0 | Corrected by powerful model. |
| Fallback (Error) | 502 | 35 | 0 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 8030 | 382 | 34 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 7451 | 363 | 34 |
| CompanyInfo | 477 | 17 | 0 |
...
![](https://img.shields.io/badge/GoogleAlertManager-7451_calls-blue)
![](https://img.shields.io/badge/CompanyInfo-477_calls-green)
...
![](https://img.shields.io/badge/CompanyInfo-786_calls-blue)
...
| Model | Total Calls | Last 7D | Last 24H | Avg Duration |
|-------|-------------|---------|----------|--------------|
| `whisper-large-v3` | 1396 | 17 | 2 | N/A |
...
| Application | Total Calls | Last 7D | Last 24H |
|-------------|-------------|---------|----------|
| whisper-transcription | 803 | 17 | 2 |
...
![](https://img.shields.io/badge/whisper--transcription-803_calls-blue)
