...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-07-14 07:35 CST*

![](https://img.shields.io/badge/Total_Calls-8099-black)
![](https://img.shields.io/badge/Last_7_Days-377-blue)
...
| Judge Replaced | 47 | 10 | 0 | Corrected by powerful model. |
| Fallback (Error) | 237 | 20 | 0 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 5735 | 282 | 34 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 5292 | 273 | 34 |
| CompanyInfo | 354 | 9 | 0 |
...
| whisper-transcription | 375 | 33 | 0 |
