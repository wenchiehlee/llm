...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-08-21 04:01 CST*

![](https://img.shields.io/badge/Total_Calls-10574-black)
![](https://img.shields.io/badge/Last_7_Days-561-blue)
...
| Judge Replaced | 70 | 8 | 0 | Corrected by powerful model. |
| Fallback (Error) | 449 | 24 | 0 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 7455 | 454 | 39 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 6903 | 442 | 39 |
| CompanyInfo | 452 | 12 | 0 |
...
| Model | Total Calls | Last 7D | Last 24H | Avg Duration |
|-------|-------------|---------|----------|--------------|
| `whisper-large-v3` | 1363 | 39 | 0 | N/A |
...
| Application | Total Calls | Last 7D | Last 24H |
|-------------|-------------|---------|----------|
| whisper-transcription | 770 | 39 | 0 |
