...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-07-23 12:57 CST*
...
| Judge Replaced | 53 | 4 | 0 | Corrected by powerful model. |
| Fallback (Error) | 279 | 35 | 0 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 6069 | 297 | 72 | N/A |
...
| Model | Total Calls | Last 7D | Last 24H | Avg Duration |
|-------|-------------|---------|----------|--------------|
| `whisper-large-v3` | 1206 | 195 | 3 | N/A |
...
| Application | Total Calls | Last 7D | Last 24H |
|-------------|-------------|---------|----------|
| whisper-transcription | 612 | 195 | 3 |
