...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-09-20 08:23 CST*

![](https://img.shields.io/badge/Total_Calls-19901-black)
![](https://img.shields.io/badge/Last_7_Days-1547-blue)
...
| Fallback (Error) | 567 | 24 | 0 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 9650 | 696 | 52 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 9001 | 672 | 52 |
| CompanyInfo | 542 | 24 | 0 |
...
![](https://img.shields.io/badge/GoogleAlertManager-9001_calls-blue)
![](https://img.shields.io/badge/CompanyInfo-542_calls-green)
...
![](https://img.shields.io/badge/CompanyInfo-874_calls-blue)
...
| `whisper-large-v3` | 1520 | 24 | 0 | N/A |
...
| whisper-transcription | 928 | 24 | 0 |
...
![](https://img.shields.io/badge/whisper--transcription-928_calls-green)
