...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-06-21 21:25 CST*

![](https://img.shields.io/badge/Total_Calls-6912-black)
![](https://img.shields.io/badge/Last_7_Days-304-blue)
...
| Judge Replaced | 22 | 3 | 0 | Corrected by powerful model. |
| Fallback (Error) | 146 | 29 | 8 | Automatic fallback to Gemini. |
| NAS Reflection | 60 | 5 | 0 | App used draft_provider='codex'; draft+judge ran entirely on NAS via gemini-cli. |

#### Smart Routing by Application

| App | Total | Last 7D | Last 24H |
|-----|-------|---------|----------|
| CompanyInfo | 198 | 37 | 8 |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 4824 | 263 | 40 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 4423 | 250 | 36 |
| CompanyInfo | 316 | 13 | 4 |
