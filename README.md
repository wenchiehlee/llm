...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-08-24 04:58 CST*

![](https://img.shields.io/badge/Total_Calls-10881-black)
![](https://img.shields.io/badge/Last_7_Days-537-blue)
...
| Judge Replaced | 72 | 6 | 0 | Corrected by powerful model. |
| Fallback (Error) | 467 | 32 | 0 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 7718 | 446 | 36 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 7158 | 431 | 36 |
| CompanyInfo | 460 | 15 | 0 |
