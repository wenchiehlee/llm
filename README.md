...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-06-28 23:56 CST*

![](https://img.shields.io/badge/Total_Calls-7304-black)
...
| Judge Replaced | 25 | 4 | 1 | Corrected by powerful model. |
| Fallback (Error) | 176 | 26 | 4 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 5122 | 294 | 36 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 4742 | 284 | 34 |
| CompanyInfo | 328 | 10 | 2 |
