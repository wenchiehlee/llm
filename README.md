...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-08-15 15:58 CST*

![](https://img.shields.io/badge/Total_Calls-10052-black)
![](https://img.shields.io/badge/Last_7_Days-529-blue)
![](https://img.shields.io/badge/Last_24_Hours-90-green)
...
| Judge Replaced | 62 | 4 | 0 | Corrected by powerful model. |
| Fallback (Error) | 425 | 31 | 0 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 7040 | 388 | 75 | N/A |
...
| Model | Total Calls | Last 7D | Last 24H | Avg Duration |
|-------|-------------|---------|----------|--------------|
| `whisper-large-v3` | 1324 | 68 | 15 | N/A |
...
| Application | Total Calls | Last 7D | Last 24H |
|-------------|-------------|---------|----------|
| whisper-transcription | 731 | 69 | 15 |
