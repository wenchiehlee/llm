...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-08-11 04:22 CST*

![](https://img.shields.io/badge/Total_Calls-9789-black)
![](https://img.shields.io/badge/Last_7_Days-418-blue)
...
| Judge Replaced | 60 | 3 | 0 | Corrected by powerful model. |
| Fallback (Error) | 404 | 36 | 0 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 6877 | 311 | 37 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 6355 | 293 | 37 |
| CompanyInfo | 431 | 16 | 0 |
