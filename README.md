...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-05-23 15:18 CST*

![](https://img.shields.io/badge/Total_Calls-5458-black)
![](https://img.shields.io/badge/Last_7_Days-433-blue)
...
| Fallback (Error) | 39 | 21 | 0 | Automatic fallback to Gemini. |
| NAS Reflection | 16 | 11 | 0 | App used draft_provider='codex'; draft+judge ran entirely on NAS via gemini-cli. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 3708 | 355 | 35 | N/A |
...
| Model | Total Calls | Last 7D | Last 24H | Avg Duration |
|-------|-------------|---------|----------|--------------|
| `whisper-large-v3` | 774 | 29 | 29 | N/A |
...
| whisper-transcription | 180 | 29 | 29 |
