...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-06-29 18:12 CST*
...
| Judge Replaced | 26 | 4 | 0 | Corrected by powerful model. |
| Fallback (Error) | 180 | 20 | 0 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 5158 | 290 | 33 | N/A |
