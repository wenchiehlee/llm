...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-07-23 18:51 CST*

![](https://img.shields.io/badge/Total_Calls-8740-black)
![](https://img.shields.io/badge/Last_7_Days-561-blue)
![](https://img.shields.io/badge/Last_24_Hours-92-green)
...
| Judge Replaced | 53 | 5 | 1 | Corrected by powerful model. |
| Fallback (Error) | 279 | 41 | 6 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 6069 | 300 | 75 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 5608 | 282 | 72 |
| CompanyInfo | 372 | 18 | 3 |
...
| Model | Total Calls | Last 7D | Last 24H | Avg Duration |
|-------|-------------|---------|----------|--------------|
| `whisper-large-v3` | 1206 | 200 | 8 | N/A |
...
| Application | Total Calls | Last 7D | Last 24H |
|-------------|-------------|---------|----------|
| whisper-transcription | 612 | 200 | 8 |
