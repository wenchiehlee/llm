...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-08-17 12:24 CST*

![](https://img.shields.io/badge/Total_Calls-10298-black)
![](https://img.shields.io/badge/Last_7_Days-544-blue)
![](https://img.shields.io/badge/Last_24_Hours-75-green)
...
| Judge Replaced | 65 | 5 | 0 | Corrected by powerful model. |
| Fallback (Error) | 431 | 27 | 0 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 7235 | 393 | 75 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 6692 | 372 | 75 |
| CompanyInfo | 443 | 12 | 0 |
...
| skill-youtube-channel-srt-keyframe-extract | 24 | 24 | 0 |
...
| Model | Total Calls | Last 7D | Last 24H | Avg Duration |
|-------|-------------|---------|----------|--------------|
| `whisper-large-v3` | 1351 | 72 | 0 | N/A |
...
| Application | Total Calls | Last 7D | Last 24H |
|-------------|-------------|---------|----------|
| whisper-transcription | 758 | 73 | 0 |
