...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-07-05 07:43 CST*

![](https://img.shields.io/badge/Total_Calls-7617-black)
![](https://img.shields.io/badge/Last_7_Days-301-blue)
...
| Judge Replaced | 32 | 6 | 0 | Corrected by powerful model. |
| Fallback (Error) | 206 | 26 | 0 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 5411 | 253 | 32 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 4985 | 242 | 32 |
| CompanyInfo | 340 | 10 | 0 |
