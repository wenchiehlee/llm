...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-07-15 14:59 CST*

![](https://img.shields.io/badge/Total_Calls-8133-black)
![](https://img.shields.io/badge/Last_7_Days-335-blue)
...
| Judge Replaced | 47 | 9 | 0 | Corrected by powerful model. |
| Fallback (Error) | 237 | 17 | 0 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 5769 | 282 | 36 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 5326 | 274 | 36 |
| CompanyInfo | 354 | 8 | 0 |
