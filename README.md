...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-07-22 18:50 CST*

![](https://img.shields.io/badge/Total_Calls-8695-black)
![](https://img.shields.io/badge/Last_7_Days-550-blue)
...
| Judge Replaced | 53 | 5 | 0 | Corrected by powerful model. |
| Fallback (Error) | 272 | 40 | 7 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 6032 | 263 | 37 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 5574 | 246 | 34 |
| CompanyInfo | 369 | 17 | 3 |
...
| Model | Total Calls | Last 7D | Last 24H | Avg Duration |
|-------|-------------|---------|----------|--------------|
| `whisper-large-v3` | 1206 | 226 | 0 | N/A |
...
| Application | Total Calls | Last 7D | Last 24H |
|-------------|-------------|---------|----------|
| whisper-transcription | 612 | 226 | 0 |
