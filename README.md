...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-06-29 22:38 CST*

![](https://img.shields.io/badge/Total_Calls-7346-black)
...
| Judge Replaced | 26 | 6 | 2 | Corrected by powerful model. |
| Fallback (Error) | 180 | 24 | 4 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 5158 | 292 | 35 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 4773 | 282 | 33 |
| CompanyInfo | 330 | 10 | 2 |
...
| whisper-transcription | 310 | 10 | 0 |
