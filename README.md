...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-09-13 14:46 CST*

![](https://img.shields.io/badge/Total_Calls-18331-black)
![](https://img.shields.io/badge/Last_7_Days-3049-blue)
![](https://img.shields.io/badge/Last_24_Hours-67-green)
...
| Fallback (Error) | 539 | 19 | 0 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 8938 | 568 | 64 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 8317 | 548 | 64 |
| CompanyInfo | 514 | 19 | 0 |
...
| TW-institutional-investment-theses | 1 | 0 | 0 |
| TW-institutional-research | 1 | 0 | 0 |
| debug-probe-app | 1 | 0 | 0 |
| diagnostic-test | 1 | 0 | 0 |

![](https://img.shields.io/badge/GoogleAlertManager-8317_calls-blue)
![](https://img.shields.io/badge/CompanyInfo-514_calls-green)
...
![](https://img.shields.io/badge/CompanyInfo-846_calls-blue)
...
| Model | Total Calls | Last 7D | Last 24H | Avg Duration |
|-------|-------------|---------|----------|--------------|
| `baidu/Unlimited-OCR` | 5996 | 2430 | 0 | N/A |
| `whisper-large-v3` | 1493 | 17 | 3 | N/A |
...
| Application | Total Calls | Last 7D | Last 24H |
|-------------|-------------|---------|----------|
| Baidu-OCR | 5996 | 2430 | 0 |
| whisper-transcription | 901 | 17 | 3 |
...
![](https://img.shields.io/badge/Baidu--OCR-5996_calls-blue)
![](https://img.shields.io/badge/whisper--transcription-901_calls-green)
