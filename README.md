...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-07-03 04:06 CST*

![](https://img.shields.io/badge/Total_Calls-7525-black)
...
| Judge Replaced | 28 | 3 | 0 | Corrected by powerful model. |
| Fallback (Error) | 198 | 22 | 0 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 5305 | 252 | 34 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 4917 | 243 | 34 |
| CompanyInfo | 336 | 8 | 0 |
