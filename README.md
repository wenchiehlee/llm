...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-05-29 21:49 CST*

![](https://img.shields.io/badge/Total_Calls-5805-black)
...
|--------|-------|---------|----------|-------------|
| Draft Passed | 4 | 1 | 1 | Saved powerful model cost. |
| Judge Replaced | 5 | 1 | 0 | Corrected by powerful model. |
| Fallback (Error) | 59 | 28 | 8 | Automatic fallback to Gemini. |
| NAS Reflection | 28 | 17 | 5 | App used draft_provider='codex'; draft+judge ran entirely on NAS via gemini-cli. |

#### Smart Routing by Application

| App | Total | Last 7D | Last 24H |
|-----|-------|---------|----------|
| CompanyInfo | 68 | 38 | 12 |
| InvestorEvents | 19 | 9 | 2 |
| ConceptStocks | 9 | 0 | 0 |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 3928 | 260 | 40 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 3567 | 247 | 36 |
| CompanyInfo | 277 | 11 | 4 |
