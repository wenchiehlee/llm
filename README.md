...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-07-16 22:36 CST*

![](https://img.shields.io/badge/Total_Calls-8194-black)
...
| Judge Replaced | 48 | 10 | 1 | Corrected by powerful model. |
| Fallback (Error) | 239 | 21 | 5 | Automatic fallback to Gemini. |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 5806 | 286 | 38 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 5362 | 276 | 36 |
| CompanyInfo | 355 | 10 | 2 |
...
| Model | Total Calls | Last 7D | Last 24H | Avg Duration |
|-------|-------------|---------|----------|--------------|
| `whisper-large-v3` | 983 | 39 | 28 | N/A |
...
| whisper-transcription | 390 | 39 | 28 |
