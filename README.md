...
*Powered by [Amplitude Analytics](https://amplitude.com) · Updated: 2026-09-06 22:23 CST*

![](https://img.shields.io/badge/Total_Calls-14564-black)
![](https://img.shields.io/badge/Last_7_Days-2420-blue)
![](https://img.shields.io/badge/Last_24_Hours-797-green)
...
| Fallback (Error) | 518 | 16 | 2 | Automatic fallback to Gemini. |
| NAS Reflection | 69 | 9 | 2 | App used draft_provider='codex'; draft+judge ran entirely on NAS via gemini-cli. |

#### Smart Routing by Application

| App | Total | Last 7D | Last 24H |
|-----|-------|---------|----------|
| CompanyInfo | 630 | 27 | 4 |
...
|-------|-------------|---------|----------|--------------|
| `gemini-2.5-flash` | 8400 | 368 | 34 | N/A |
...
|-------------|-------------|---------|----------|
| GoogleAlertManager | 7801 | 348 | 32 |
| CompanyInfo | 493 | 16 | 2 |
| ConceptStocks | 32 | 0 | 0 |
| InvestorEvents | 29 | 0 | 0 |
| TAIEX_Finguider_Pro | 25 | 0 | 0 |
| skill-youtube-channel-srt-keyframe-extract | 11 | 1 | 0 |
| llm-api | 8 | 0 | 0 |
...
![](https://img.shields.io/badge/GoogleAlertManager-7801_calls-blue)
![](https://img.shields.io/badge/CompanyInfo-493_calls-green)
...
![](https://img.shields.io/badge/CompanyInfo-810_calls-blue)
...
| Model | Total Calls | Last 7D | Last 24H | Avg Duration |
|-------|-------------|---------|----------|--------------|
| `baidu/Unlimited-OCR` | 2819 | 1969 | 757 | N/A |
...
![](https://img.shields.io/badge/Baidu--OCR-2819_calls-blue)
![](https://img.shields.io/badge/whisper--transcription-885_calls-green)
